...
For help on the settings in the `.jsbeautifyrc` see [Settings.md](https://github.com/feliperohdee/vscode-beautify/blob/master/Settings.md)
...
For information on contributing see [Contributing.md](https://github.com/feliperohdee/vscode-beautify/blob/master/.github/CONTRIBUTING.md)
