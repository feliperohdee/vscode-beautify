...
exports.activate = (context) => {
  ...
  sub.push(vscode.commands.registerCommand('beautify', formatActiveDocument.bind(0, true)));
  sub.push(vscode.commands.registerCommand('beautifyFile', formatActiveDocument.bind(0, false)));
